...
install("copleykj:livestamp");                                                                                         // 80
install("ddp-rate-limiter");                                                                                           // 81
install("localstorage");                                                                                               // 82
install("callback-hook");                                                                                              // 83
install("accounts-base", "meteor/accounts-base/client_main.js");                                                       // 84
install("sha");                                                                                                        // 85
install("srp");                                                                                                        // 86
install("accounts-password");                                                                                          // 87
install("service-configuration");                                                                                      // 88
install("reactive-dict");                                                                                              // 89
install("session");                                                                                                    // 90
install("less");                                                                                                       // 91
install("accounts-ui-unstyled");                                                                                       // 92
install("accounts-ui");                                                                                                // 93
install("standard-app-packages");                                                                                      // 94
install("mobile-status-bar");                                                                                          // 95
install("tmeasday:crypto-base");                                                                                       // 96
install("tmeasday:crypto-md5");                                                                                        // 97
install("tmeasday:gravatar");                                                                                          // 98
install("aldeed:template-extension");                                                                                  // 99
install("brentjanderson:buzz");                                                                                        // 100
install("autoupdate");                                                                                                 // 101
install("meteor-platform");                                                                                            // 102
install("webapp");                                                                                                     // 103
install("logging");                                                                                                    // 104
install("livedata");                                                                                                   // 105
install("ui");                                                                                                         // 106
install("launch-screen");                                                                                              // 107
install("filive:style");                                                                                               // 108
